...
public class TextTest {
    ...
    void cont5DigTest1(String str) {
        System.out.println("Test pozytywny dla 5 cyfr: " + str);
    ...
    void cont5DigTest2(String str) {
        System.out.println("Test negatywny dla 5 cyfr: " + str);
    ...
    void numberCountTest1(String str, int value) {
        System.out.println("Test pozytywny dla liczby cyfr: " + str);
    ...
    void numberCountTest2(String str) {
        System.out.println("Test negatywny dla liczby cyfr: " + str);
    ...
    void noNumbersTest1(String str) {
        System.out.println("Test pozytywny dla braku cyfr: " + str);
    ...
    void noNumbersTest2(String str) {
        System.out.println("Test negatywny dla braku cyfr: " + str);
    ...
    void onlyDigitsTest1(String str) {
        System.out.println("Test pozytywny dla tylko cyfr: " + str);
    ...
    void onlyDigitsTest2(String str) {
        System.out.println("Test negatywny dla tylko cyfr: " + str);
